...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('load', function () {
  setTimeout(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-loader').fadeOut('slow');
  }, 1000);
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#textAnimator').rotaterator({
    fadeSpeed: 500,
    pauseSpeed: 7500
  });
});
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/tejidomigrante.cl/src/assets/js/app.js */"./src/assets/js/app.js");
